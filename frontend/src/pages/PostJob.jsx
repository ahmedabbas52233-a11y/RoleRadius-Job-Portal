        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="card p-5">
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {skills.map(s => (
                <span key={s} className="flex items-center gap-1 px-3 py-1.5 rounded-xl text-sm font-medium" style={{background:'var(--primary-light)',color:'var(--primary-dark)',border:'1px solid rgba(99,102,241,.2)'}}>
                  {s}
